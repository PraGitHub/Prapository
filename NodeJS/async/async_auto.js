...
const login = (username, password) => {
    async.auto({
            processUserData: (callback) => {
                ...
                console.log(`Processed user = ${username}'s data`);
        ...
        lookUpUser: ['processUserData', 'connectToDb', (results, callback) => {
                setTimeout(() => {
                    console.log(`userid = ${results.processUserData.userid}, pw = ${results.processUserData.pw}, connected to db = ${results.connectToDb.connected}`);
